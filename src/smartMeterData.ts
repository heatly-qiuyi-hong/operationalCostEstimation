...
async function smartMeterData(
  startTime: string = "2025-11-18T00:00:00",
  endTime: string = "2025-11-18T23:59:59",
) {
  ...
  async function getUser() {
    try {
      const response = await axios.get(
        `https://api.glowmarkt.com/api/v0-1/resource/${headers.resoureId}/readings`,
        {
          params: params,
          headers: headers,
        },
